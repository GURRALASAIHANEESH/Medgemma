...
from modules.ocr_utils import perform_ocr
from modules.clinical_parser import extract_clinical_fields
from modules.risk_engine import assess_risk
from modules.history_manager import load_patient_history, save_patient_visit, summarize_trends
from modules.summary_writer import (
    generate_referral_summary,
    save_summary_to_file,
    save_clinical_record_json
)
from modules.medgemma_bridge import extract_clinical_data_medgemma, extract_symptoms_medgemma
...
def test_trend_escalation():
    ...
    from modules.history_manager import save_patient_visit, load_patient_history, summarize_trends
